...
// Append the green button to the body or another appropriate container
...
Telegram.WebApp.onEvent(paymentButton, function(){
    // Отправляем данные о товаре
    tg.sendData(item);

    // Вызываем функцию оплаты
    tg.pay({
        payload: "описание товара",
        provider_token: "1744374395:TEST:2f9b6efe22bc34a6486d",
        start_parameter: "start_parameter",
        currency: "rub", // валюта
        prices: [{ label: "Цена", amount: 100 }] // указываем цену товара
    });
});

// Получаем информацию о пользователе и отображаем в usercard
